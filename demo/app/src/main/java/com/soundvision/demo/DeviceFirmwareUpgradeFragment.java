...
import com.soundvision.demo.dfu.adapter.FileBrowserAppsAdapter;
import com.soundvision.demo.dfu.fragment.UploadCancelFragment;
import com.soundvision.demo.dfu.fragment.ZipInfoFragment;
import com.soundvision.demo.dfu.hawkbit.UpgradeClientService;
import com.soundvision.demo.dfu.settings.SettingsFragment;
...
public class DeviceFirmwareUpgradeFragment extends Fragment implements IBLETransferClient, LoaderCallbacks<Cursor>, //ScannerFragment.OnDeviceSelectedListener,
    ...
    private UpgradeClientService upgradeService;
    ...
    public View onCreateView(
        ...
        return inflater.inflate(R.layout.activity_feature_dfu, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        upgradeService = new UpgradeClientService();
...
*/
    ...
    private void setGUI() {
        ...
        deviceNameView = getView().findViewById(R.id.device_name);
        fileNameView = getView().findViewById(R.id.file_name);
        fileTypeView = getView().findViewById(R.id.file_type);
        fileScopeView = getView().findViewById(R.id.file_scope);
        fileSizeView = getView().findViewById(R.id.file_size);
        fileStatusView = getView().findViewById(R.id.file_status);
        selectFileButton = getView().findViewById(R.id.action_select_file);
        uploadButton = getView().findViewById(R.id.action_upload);
        //connectButton = getView().findViewById(R.id.action_connect);
        textPercentage = getView().findViewById(R.id.textviewProgress);
        textUploading = getView().findViewById(R.id.textviewUploading);
        progressBar = getView().findViewById(R.id.progressbar_file);
...
*/
        ...
        switch (requestCode) {
            case SELECT_FILE_REQ: {
                ...
                if (uri.getScheme().equals("file")) {
                    ...
                    getActivity().getLoaderManager().restartLoader(SELECT_FILE_REQ, bundle, this);
                }
                break;
            }
    ...
    public Loader<Cursor> onCreateLoader(final int id, final Bundle args) {
        ...
        return new CursorLoader(getContext(), uri, null /* all columns, instead of projection */, null, null, null);
    }
    ...
    private void updateFileInfo(final String fileName, final long fileSize, final int fileType) {
        ...
        if (statusOk) {
            if (fileType != DfuService.TYPE_AUTO) {
                ...
                new AlertDialog.Builder(getContext()).setTitle(R.string.dfu_file_scope_title).setCancelable(false)
    ...
    public void onSelectFileHelpClicked(final View view) {
        ...
        upgradeService.Connect(getContext(), (filename, fileSize) -> updateFileInfo(filename, fileSize, DfuService.TYPE_AUTO));
    ...
    public void onSelectFileClicked(final View view) {
        ...
        new AlertDialog.Builder(getContext())
                ...
                .setNeutralButton(R.string.dfu_file_info, (dialog, which) -> {
                    ...
                    fragment.show(getActivity().getSupportFragmentManager(), "help_fragment");
                })
    ...
    private void openFileChooser() {
        ...
        if (intent.resolveActivity(getActivity().getPackageManager()) != null) {
            ...
            appsList.setAdapter(new FileBrowserAppsAdapter(getContext()));
    ...
    private boolean isDfuServiceRunning() {
        final ActivityManager manager = (ActivityManager) getActivity().getSystemService(ACTIVITY_SERVICE);
    ...
    {
        Button b = getView().findViewById(R.id.action_select_file);
        b.setOnClickListener(this);

        b = getView().findViewById(R.id.action_upload);
        b.setOnClickListener(this);
        //b = getView().findViewById(R.id.action_connect);
        //b.setOnClickListener(this);
        View v = getView().findViewById(R.id.file_update_check);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
           ...
           /* case R.id.action_connect:
                onConnectClicked(v);
                break;*/
            case R.id.file_update_check:
                onSelectFileHelpClicked(v);
                break;
        }
    }
...
/// Device
    ...
    public void DeviceSelect(@NonNull final BluetoothDevice device, final String name) {
        //final Intent intent = getIntent();
        final String overwrittenName = name;//intent.getStringExtra(DfuService.EXTRA_DEVICE_NAME);
        ...
        final int type = DfuService.TYPE_AUTO;
        final boolean keepBond = false;//intent.getBooleanExtra(DfuService.EXTRA_KEEP_BOND, false);
    ...
    public void OnDeviceConnect(BluetoothDevice device) {
        selectedDevice = device;
        if (getActivity() != null && uploadButton != null) {
            uploadButton.setEnabled(statusOk);
            deviceNameView.setText(device.getName() != null ? device.getName() : getString(R.string.not_available));
            DeviceSelect(device, device.getName());
        }
    }
