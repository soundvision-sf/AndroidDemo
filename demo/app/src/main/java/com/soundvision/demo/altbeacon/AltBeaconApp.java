...
//
//public class AltBeaconApp {
//
//    public void init(Context ctx, androidx.lifecycle.Observer<Collection<Beacon>> observerBeacons) {
//
//        BeaconManager beaconManager = BeaconManager.getInstanceForApplication(ctx);
//
...
//        RegionViewModel regionViewModel = BeaconManager.getInstanceForApplication(ctx).getRegionViewModel(region);
//        // observer will be called each time the monitored regionState changes (inside vs. outside region)
//        regionViewModel.getRegionState().observeForever(new androidx.lifecycle.Observer<Integer>() {
//            @Override
...
//
//        regionViewModel.getRangedBeacons().observeForever(observerBeacons);
//
//
//    }
///*
//    private void setupForegroundService() {
//        Notification.Builder builder = new Notification.Builder(this, "BeaconReferenceApp");
...
//*/
//
//    final Observer centralMonitoringObserver = new Observer() {
//        @Override
...
//   }*/
//
//    final Observer centralRangingObserver = new Observer() {
//        @Override
//        public void update(Observable o, Object arg) {
//            Collection<Beacon> beacons = (Collection<Beacon>) arg;
